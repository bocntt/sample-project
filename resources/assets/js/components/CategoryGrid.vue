  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <section class="panel">
            ...
            <thead>
              <tr>
                <th v-for="key in gridColumns"
                  ...
                  <span class="arrow"
                        v-bind:class="sortOrdder > 0 ? 'asc' : 'dsc'">
        ...
        <div class="pull-right">
          pahe {{ current_page }} of {{ last_page }} pages
        </div>
...
<script>
  export default {
    ...
    methods: {
      sortBy: function(key) {
        this.sortKey = (this.sortOrdder == 1) ? -1 : 1;
        this.getData(1);
      },
        ...
        if (this.query == '' && getPage != null) {
          ...
          if (getPage != null) {
            $.getJSON(getPage, function(data) {
              ...
              this.total = data.total;
              this.last_page = data.last_page;
              this.next_page_url = (data.next_page_url == null) ? null :
                    data.next_page_url + '&keyword=' + this.query;
              this.prev_page_url = (data.prev_page_url == null) ? null :
